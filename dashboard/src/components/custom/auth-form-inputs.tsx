...
export const CustomAuthPasswordInput = React.forwardRef<HTMLInputElement, InputProps>(
	({ className, ...props }, ref) => {
...
export const CustomAuthInput = React.forwardRef<HTMLInputElement, InputProps>(
			...
			<div className='relative'>
				<div className='flex flex-wrap'>
					{React.Children.map(children, (child) => {
						...
						return <div className={cx('w-full', 'mb-4')}>{child}</div>;
					})}
				</div>
			</div>
		</div>
